...
def process_and_concatenate_csv():
    ...
    current_file = "database/PAGO_Transações_04-08-2025_15-16-47.csv"
    ...
    # Extrair CPF do nome do arquivo - Para arquivo do Cícero
    # Como o arquivo é PAGO_Transações, vamos usar dados específicos do Cícero
    cpf_cnpj = "040525196-39"  # CPF do Cícero
    nome = "Cícero Sousa Araújo Filho"  # Nome do Cícero
    ...
    df_approved = df_current[df_current['Status'] == 'Aprovada'].copy()
